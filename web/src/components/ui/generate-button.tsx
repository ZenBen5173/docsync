    ...
    <div className="relative inline-block group">
      <style>{`
        ...
        .gen-txt-2 {
          position: absolute;
          word-spacing: -1em;
          white-space: nowrap;      /* a longer label must widen the pill, never wrap inside it */
        }
      ...
      >
        ...
        <div className="gen-txt-wrapper" style={{ minWidth: `${Math.max(6.4, Math.max(label.length, (activeLabel ?? "").length) * 0.6)}em` }}>
